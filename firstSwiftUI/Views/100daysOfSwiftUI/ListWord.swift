...
@available(iOS 15.0, *)
struct ListWord: View {
    @State private var usedWords: [String] = [String]()
    @State private var rootWords = "Words"
    ...
    func addNewWord() {
        ...
        guard isPossible(word: answer) else {
            wordError(title: "Word not possible", message: "You can't spell that word from '\(rootWords)'!")
            return
        }
...
struct ListWord_Previews: PreviewProvider {
